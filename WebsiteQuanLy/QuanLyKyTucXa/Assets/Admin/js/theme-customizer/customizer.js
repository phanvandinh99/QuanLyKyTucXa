(function ($) {
  ...
  $(
    '<div class="customizer-links"><div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical"><a class="nav-link" id="c-pills-home-tab" data-bs-toggle="pill" href="#c-pills-home" role="tab" aria-controls="c-pills-home" aria-selected="true" data-original-title=""><div class="settings"><img class="img-fluid" src="/Assets/Admin/images/customizer/1.png" alt="TC"></div><span>Tuỳ Chỉnh</span></a> <a class="nav-link" target="_blank" href="https://docs.pixelstrap.net/admin/riho/document/" data-original-title=""><div><img class="img-fluid fa-spin" src="/Assets/Admin/images/customizer/2.png" alt="nft"></div><span>Nguồn</span></a> <a class="nav-link" target="_blank" href="https://themeforest.net/user/pixelstrap/portfolio" target="_blank" data-original-title=""><div><img class="img-fluid" src="/Assets/Admin/images/customizer/3.png" alt="nft"></div><span>Giỏ Hàng</span></a> <a class="nav-link" target="_blank" href="https://admin.pixelstrap.net/riho/template/landing-page.html" data-original-title=""><div><img class="img-fluid" src="/Assets/Admin/images/customizer/4.png" alt="nft"></div><span>Kiểm Thử Giao Diện</span></a> <a class="nav-link" target="_blank" href="https://support.pixelstrap.com/portal/en/signin" data-original-title=""><div><img class="img-fluid" src="/Assets/Admin/images/customizer/5.png" alt="nft"></div><span>Trợ Giúp</span></a></div></div><div class="customizer-contain"><div class="tab-content" id="c-pills-tabContent"><div class="customizer-header"><i class="icofont-close icon-close"></i><span class="f-20 f-w-600 txt-dark">TUỲ CHỈNH GIAO DIỆN</span><p class="mb-0">Thay đổi bố cục, màu sắc bên dưới... <i class="fa fa-thumbs-o-up txt-primary"></i></p></div><div class="customizer-body custom-scrollbar"><div class="tab-pane fade show active" id="c-pills-home" role="tabpanel" aria-labelledby="c-pills-home-tab"><h5>Kiểu Layout</h5><ul class="main-layout d-flex align-items-center layout-grid"><li data-attr="ltr" class="active"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-light sidebar"></li><li class="bg-light body "><span class="badge badge-primary">LTR</span></li></ul></div></li><li data-attr="rtl"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-light body"><span class="badge badge-primary">RTL</span></li><li class="bg-light sidebar"></li></ul></div></li><li data-attr="ltr" class="box-layout px-3"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-light sidebar"></li><li class="bg-light body"><span class="badge badge-primary">Box</span></li></ul></div></li></ul><h5>Kiểu Sidebar</h5><ul class="sidebar-type layout-grid"><li data-attr="normal-sidebar"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-dark sidebar"></li><li class="bg-light body"></li></ul></div></li><li data-attr="compact-sidebar"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-dark sidebar compact"></li><li class="bg-light body"></li></ul></div></li></ul><h5>Sidebar Icon</h5><ul class="sidebar-setting layout-grid"><li class="active" data-attr="stroke-svg"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body bg-light"><span class="badge badge-primary">Stroke</span></div></li><li data-attr="fill-svg"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body bg-light"><span class="badge badge-primary">Fill</span></div></li></ul><h5>Màu sắc</h5><ul class="layout-grid unlimited-color-layout"><input id="ColorPicker1" type="color" value="#006666" name="Background"><input id="ColorPicker2" type="color" value="#FF6150" name="Background"><button type="button" class="color-apply-btn btn btn-primary color-apply-btn">Apply</button></ul><h5>Màu sáng</h5><ul class="layout-grid customizer-color"><li class="color-layout" data-attr="color-1" data-primary="#006666" data-secondary="#FF6150"><div></div></li><li class="color-layout" data-attr="color-2" data-primary="#1D5B79" data-secondary="#A16B56"><div></div></li><li class="color-layout" data-attr="color-3" data-primary="#4A55A2" data-secondary="#F0A360"><div></div></li><li class="color-layout" data-attr="color-4" data-primary="#167A93" data-secondary="#eeb82f"><div></div></li><li class="color-layout" data-attr="color-5" data-primary="#423964" data-secondary="#FFA47A"><div></div></li><li class="color-layout" data-attr="color-6" data-primary="#4b2a4b" data-secondary="#FE7088"><div></div></li></ul><h5>Màu tối</h5><ul class="layout-grid customizer-color dark"><li class="color-layout" data-attr="color-1" data-primary="#006666" data-secondary="#FE6A49"><div></div></li><li class="color-layout" data-attr="color-2" data-primary="#1D5B79" data-secondary="#468B97"><div></div></li><li class="color-layout" data-attr="color-3" data-primary="#4A55A2" data-secondary="#F0A360"><div></div></li><li class="color-layout" data-attr="color-4" data-primary="#167A93" data-secondary="#eeb82f"><div></div></li><li class="color-layout" data-attr="color-5" data-primary="#423964" data-secondary="#897D5e"><div></div></li><li class="color-layout" data-attr="color-6" data-primary="#4b2a4b" data-secondary="#FE7088"><div></div></li></ul><h5>Màu bố cục</h5><ul class="layout-grid customizer-mix"><li class="color-layout active" data-attr="light-only"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-light sidebar"></li><li class="bg-light body"></li></ul></div></li><li class="color-layout" data-attr="dark-sidebar"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-dark sidebar"></li><li class="bg-light body"></li></ul></div></li><li class="color-layout" data-attr="dark-only"><div class="header bg-dark"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-dark sidebar"></li><li class="bg-dark body"></li></ul></div></li></ul></div>'
  ).appendTo($("body"));
  (function () { })();
  //live customizer js  
